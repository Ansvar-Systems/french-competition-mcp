# French Competition MCP

**French competition data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/french-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add french-competition-mcp --transport http https://mcp.ansvar.eu/french-competition/mcp` |
...
```json
{
  "mcpServers": {
    "french-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/french-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/french-competition-mcp
```
...
```json
{
  "mcpServers": {
    "french-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/french-competition-mcp"]
    }
  }
}
```
...
- **Autorite de la concurrence** -- Official regulatory authority
...
>
> Regulatory data is sourced from official publications by Autorite de la concurrence. However:
...
```bash
git clone https://github.com/Ansvar-Systems/french-competition-mcp
